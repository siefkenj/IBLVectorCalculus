...
\subsection*{Arc Length Parameterization}
	...
	\begin{Enum}
		...
		\item Parameterize $C$ so that the speed of the particle starts is $0$ at six points along the curve.
	\end{Enum}
	...
	\begin{Enum}
		\item Write an expression for the speed of a particle at time $t$.
