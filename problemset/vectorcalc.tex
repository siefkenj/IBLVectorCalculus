...
\subsection*{Multidimensional Limits}
	...
	\begin{Enum}
		\item Suppose we guess $L=1$.  Picking $\varepsilon = 3/4$, can you find an appropriate
			$\delta$?  What if $L=-1$?  For $\varepsilon=3/4$, can you find an appropriate $\delta$?
			What if $L=0$?  What values can we rule out as possibilities for $L$?
		\item Suppose we guess $L=0$.  Picking $\varepsilon=3/4$, can you find an appropriate $\delta$?
